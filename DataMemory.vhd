...
BEGIN
	read_data(7)    <= sub_wire0(7) and mem_read;
	read_data(6)    <= sub_wire0(6) and mem_read;
	read_data(5)    <= sub_wire0(5) and mem_read;
	read_data(4)    <= sub_wire0(4) and mem_read;
	read_data(3)    <= sub_wire0(3) and mem_read;
	read_data(2)    <= sub_wire0(2) and mem_read;
	read_data(1)    <= sub_wire0(1) and mem_read;
	read_data(0)    <= sub_wire0(0) and mem_read;
...
-- Retrieval info: USED_PORT: mem_write 0 0 0 0 INPUT NODEFVAL "wren"
